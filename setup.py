...
def resource(*args):
    return os.path.join(
        os.path.abspath(os.path.join(__file__, os.pardir)), *args
    )
...
curr_dir += "/"
old_names = [
    "Examples/VCAL_params_calib_IFS.json",
    "Examples/VCAL_params_calib_IRDIS_Ks.json",
]
new_names = [
    "Examples/VCAL_params_calib_IFS_new.json",
...
setup(
    ...
    cmdclass={"install": InstallReqs, "develop": InstallDevReqs},
    packages=PACKAGES,
